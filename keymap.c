...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_preonic_1x2uC( \
      ...
      SUPER,   _______,         _______,         _______, KC_LBRC, KC_MINS, KC_EQL,  KC_RBRC, KC_P4,   KC_P5,   KC_P6,   KC_PEQL, \
      _______, _______,         _______,         _______, KC_LT,   _______, _______, KC_GT,   KC_P1,   KC_P2,   KC_P3,   KC_PENT, \
  ...
  [_RAISE] = LAYOUT_preonic_1x2uC( \
      ...
      _______,      _______,        _______,        _______,   _______, _______, _______, _______, _______, _______, _______, _______, \
      SUPER,        KC__MUTE,       KC__VOLDOWN,    KC__VOLUP, _______, _______, _______, _______, _______, _______, _______, _______, \
