...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_preonic_1x2uC( \
      ...
      _______,      _______,         _______,         _______, LOWER,   _______, RAISE,   KC_P0,   XXXXXXX, KC_PDOT, XXXXXXX  \
      ),
  ...
  [_RAISE] = LAYOUT_preonic_1x2uC( \
      ...
      RAISE,   XXXXXXX,  XXXXXXX,     XXXXXXX,   XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_LBRC, KC_RBRC, \
