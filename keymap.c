...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_preonic_1x2uC( \
      KC_GRV,  _______, _______, _______, _______, _______, _______, KC_BSPC, KC_PSLS, KC_PAST, KC_PMNS, _______, \
      _______, _______, _______, _______, _______, _______, _______, KC_P7,   KC_P8,   KC_P9,   KC_PPLS, _______, \
      SUPER,   _______, _______, _______, _______, _______, _______, KC_P4,   KC_P5,   KC_P6,   KC_PEQL, _______, \
      _______, _______, _______, _______, _______, _______, _______, KC_P1,   KC_P2,   KC_P3,   KC_PENT, _______, \
      _______, _______, _______, _______, LOWER,   _______, RAISE,   KC_P0,   KC_PDOT, _______, _______  \
      ),
